<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="cleantechapp.aspx.cs" Inherits="FillPdf._cleanTechApp" %>
...
<body style="background-color: floralwhite">
    ...
    <hr />
    <asp:Panel class="col-xs-12 col-lg-7" ID="Panel3" runat="server" BorderStyle="Double" GroupingText="Business Information" BackColor="#E5E4F0" >
    <p>Legal Business Name(Professional Corp.) / Dénomination sociale (au complet)</p>
    <asp:TextBox ID="name" placeholder="Legal Name" runat="server" style="margin-bottom: 5px" BackColor="#F6F6F6" Width="75%"></asp:TextBox>
        <div style="padding-bottom: 8px">
        <p style="margin-bottom:0px">Address / Adresse</p>
            <asp:TextBox ID="streetNumber" placeholder="Street Number/ Unit Number" runat="server" BackColor="#F6F6F6" Width="25%"></asp:TextBox>
            <asp:TextBox ID="streetName" placeholder="Street Name" runat="server" BackColor="#F6F6F6" Width="50%"></asp:TextBox>
        </div>
        <div style="padding-bottom: 8px">
            <asp:TextBox ID="city" placeholder="City/Ville" runat="server" Width="25%" BackColor="#F6F6F6"></asp:TextBox>
            <asp:TextBox ID="province" placeholder="Province" runat="server" Width="25%" BackColor="#F6F6F6"></asp:TextBox>
        </div>
        <div>
            <asp:TextBox ID="postal" placeholder="PostalCode/Code Postal" runat="server" Width="25%" BackColor="#F6F6F6"></asp:TextBox>
            <asp:TextBox ID="country" placeholder="Country/Pays" runat="server" Width="25%" BackColor="#F6F6F6"></asp:TextBox>
        </div>
        <br />
        <div>
        ...
        <div>
            ...
            <asp:TextBox ID="phone" runat="server" style="margin-bottom: 5px" BackColor="#F6F6F6"></asp:TextBox>
            <p style="margin-bottom: 0px;">Website / Site Web</p>
            <asp:TextBox ID="website" runat="server" TextMode="Url" style="margin-bottom: 5px" BackColor="#F6F6F6"></asp:TextBox>
        </div>
        <div>
            <p style="margin-bottom: 0px;">Supplier(Vendor) Name / Renseignements sur le fournisseur</p>
            <asp:TextBox ID="supplierName" runat="server" style="margin-bottom: 5px" BackColor="#F6F6F6"></asp:TextBox>
            <p style="margin-bottom: 0px;">Equipment Description / Descriptions du matériel</p>
            <asp:TextBox ID="description" runat="server" TextMode="MultiLine" style="margin-bottom: 5px" BackColor="#F6F6F6"></asp:TextBox>
        </div>
        <div>
            <p style="margin-bottom: 0px;">Equipment Cost / Coût de l'équipement</p>
            <asp:TextBox ID="cost" runat="server" TextMode="Number" style="margin-bottom: 5px" BackColor="#F6F6F6"></asp:TextBox>
            <p style="margin-bottom: 0px;">Term / Terme</p>
            <asp:TextBox ID="term" runat="server" style="margin-bottom: 5px" BackColor="#F6F6F6"></asp:TextBox>
        </div>
    <h4>Applications over $75,000 may require additional information - for example: Financial Statements / Pour les demandes sur passant la somme de 75,000$
        demande de informations additionel - etats financiers
    </h4>
    </asp:Panel>

    <div class="col-xs-12 col-lg-7">
        <h2>Please print, sign and upload the following authorization statement</h2>
...
<p>
        ...
        <br />
        <h2>Veuillez imprimer, signer et télécharger la déclaration d'autorisation suivante</h2>
        <p>
        ...
        <p style="margin-bottom:0px">Signature:</p>
            <asp:TextBox ID="signature2" runat="server" Font-Size="Large" style="margin-bottom: 5px" BackColor="#F6F6F6" Height="87px" Width="378px"></asp:TextBox>
        <p style="margin-bottom:0px">Name/Nom</p>
            <asp:TextBox ID="TextBox1" runat="server" style="margin-bottom: 5px" BackColor="#F6F6F6" Width="378px"></asp:TextBox>
        <p style="margin-bottom:0px">Title/Titre</p>
            <asp:TextBox ID="TextBox2" runat="server" style="margin-bottom: 5px" BackColor="#F6F6F6" Width="378px"></asp:TextBox><br/>
    </div>
